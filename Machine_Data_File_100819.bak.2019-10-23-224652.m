...
beamDaqs(1).calOffsets = -0.15456;                    % Array of beam calibration offset voltages for each beam calibration channel
...
actuators(1).daqDeviceName = 'PXI1Slot4';            % String specifying device name used for FastZ control
...
actuators(1).cmdOutputChanID = 1;          % AO channel number (e.g. 0) used for analog position control
actuators(1).sensorInputChanID = 1;        % AI channel number (e.g. 0) used for analog position sensing
...
resonantZoomAOChanID = 1;           % resonantZoomAOChanID: The numeric ID of the Analog Output channel to be used to control the Resonant Scanner Zoom level.
