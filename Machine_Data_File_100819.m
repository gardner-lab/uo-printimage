...
shutterChannelIDs = {'port1/line0'};      % Cell array specifying the corresponding channel on the device for each shutter eg {'PFI12'}
...
beamDaqs(1).calOffsets = -0.00382926;                    % Array of beam calibration offset voltages for each beam calibration channel
